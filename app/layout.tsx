...
export const metadata: Metadata = {
  ...
  description:
    'Tasara Limited connects raw material suppliers with international buyers. ISO 9001 certified supply, indenting, and procurement services for plastic materials since 2014.',
