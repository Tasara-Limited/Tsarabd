            ...
            <div className="space-y-6" data-aos="fade-left" data-aos-duration="900">
              ...
              <Card className="bg-gradient-to-br from-brand-500 to-brand-600 text-white border-none shadow-lg shadow-brand-500/10">
                <CardContent className="pt-8 pb-8 text-center lg:text-left">
                  ...
                  <a href="https://wa.me" className="inline-block text-2xl md:text-3xl font-extrabold tracking-tight hover:underline transition-all bg-white/10 px-5 py-2.5 rounded-xl backdrop-blur-sm" target="_blank" rel="noopener noreferrer">Chat on WhatsApp</a>
                    +8801886538187
                  </a>
                </CardContent>
              </Card>
